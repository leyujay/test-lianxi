<?php /*a:1:{s:71:"D:\phpStudy\PHPTutorial\WWW\admin\application\admins\view\order\add.php";i:1534830987;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<body style="padding: 10px;">
	...
	<form class="layui-form" style="margin-top: 10px;">
		<input type="hidden" name="pid" value="<?php echo htmlentities($data['id']); ?>">
		<div style="float: left;width: 800px;">
			<div class="layui-form-item">
				<label class="layui-form-label">编号</label>
				<div class="layui-input-inline">
					<input type="type" class="layui-input" readonly="readonly" name="id" value="<?php echo htmlentities($data['id']); ?>">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">订单号</label>
				<div class="layui-input-inline">					
					<input type="type" class="layui-input" readonly="readonly" name="order_no" value="<?php echo htmlentities($data['order_no']); ?>">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">快递单号</label>
				<div class="layui-input-inline">
					<input type="type" class="layui-input" name="ship_no" value="<?php echo htmlentities($data['ship_no']); ?>">
				</div>
			</div>
			<div class="layui-form-item">
